  ...
  <div id="app">
    <div class="table">
      ...
      <ejs-grid ref="grid" :dataSource="data" :allowFiltering="true" :filterSettings="filterOptions">
        <e-columns>
          <e-column field="id" headerText="Sr No" textAlign="Right" :customAttributes="customAttributes" width=90></e-column>
         
          <!-- Add :filter="columnFilterOptions" in below code to enable checkbox filtering -->
          <e-column field="ProjectId" headerText="Project Id" :customAttributes="customAttributes" width=90></e-column>
