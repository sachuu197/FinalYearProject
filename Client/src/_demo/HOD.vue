<template>
  <div id="app">
  <div class="table">
      <!-- <h2>All Group  your id is {{ $route.params.id }}</h2>-->
      <h2>All Group</h2>
      ...
      <ejs-grid ref="grid" :dataSource="data" :allowFiltering="true" :filterSettings="filterOptions">
        <e-columns>
          <e-column field="id" headerText="SrNo" textAlign="Right" :customAttributes="customAttributes" width=100></e-column>
          ...
          <e-column field="Type" headerText="Type" :customAttributes="customAttributes" width=100></e-column>
          <e-column field="Status" headerText="	Status" :customAttributes="customAttributes" width=120 ></e-column>
          <e-column field="Stage" headerText="Stage" :customAttributes="customAttributes" width=100></e-column>
          <e-column field="Faculty" headerText="Faculty" :customAttributes="customAttributes" width=140></e-column> 
        </e-columns>
      </ejs-grid>
    </div>  
  </div> 
